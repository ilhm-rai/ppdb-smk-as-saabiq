<footer>
  <div class="main-footer bg-green-sportpedia">
    <div class="container-fluid">
      <div class="row justify-content-between">
        <div class="col-6 col-lg-2 mb-4">
          <img src="<?= base_url("/img/logos/logo-sportpedia-w.png") ?>" class="w-100" alt="Sportpedia Logo">
        </div>
        ...
        <div class="col-12 col-lg-2">
          <div class="footer-menu">
            <div class="footer-menu-title">Sportnews</div>
  ...
  <div class="second-footer text-right">
    <div class="container">
      <p class="mb-0">&copy; <?= date('Y'); ?> Sportpedia. All right reserved.</p>
    </div>
  </div>
</footer>